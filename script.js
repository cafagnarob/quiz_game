...
function start(girl) {
  ...
  function displayHtml() {
    if (document.getElementById("start-page-body")) {
      const startPageBody = document.getElementById("start-page-body");
      startPageBody.setAttribute("id", "welcome-body");
      startPageBody.classList.remove("bar-background");
      startPageBody.innerHTML = ` <header>
      <img
        src="./Girls1/ChatGPT Image 27 mar 2026, 10_19_52.png"
        alt="logo_game"
      />
    </header>

    <main>
      <div class="tindermatch">
        <p id="Emma" class="selectedGirl">Emma</p>
        <img src="./Girls1/Girls1.GIF" alt="Emma_gif" />
      </div>

      <div class="tindermatch">
        <p id="Lisa">Lisa</p>
        <img src="./Girls1/Girls2.gif" alt="Lisa_gif" />
      </div>

      <div class="tindermatch">
        <p id="Anna">Anna</p>
        <img src="./Girls1/girls 3.gif" alt="Anna_gif" />
      </div>
    </main>

    <form action="" id="character-choice">
      <label for="character">scegli il tuo match</label>

      <div class="character-list">
        <button type="button" class="name-btn" data-value="Emma">
          <span class="arrow">▶</span>
          <span>Emma</span>
        </button>

        <button type="button" class="name-btn" data-value="Lisa">
          <span class="arrow">▶</span>
          <span>Lisa</span>
        </button>

        <button type="button" class="name-btn" data-value="Anna">
          <span class="arrow">▶</span>
          <span>Anna</span>
        </button>
      </div>
    ...
    `;
    ...
    } else if (document.getElementById("welcome-body")) {
      sidebar.innerHTML = `
          <main>
      ...
      tryAgain.addEventListener("click", () => {
        const body = document.getElementById("result-body");
        body.setAttribute("id", "start-page-body");
